...
data = {
  ...
  "triplets" : [
    ...
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Reaction_HCL","iri"],
    ["this:$(uniqid)#Reaction_HCL", "sio:SIO_000300", "$(reaction_hcl)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Salty_types","iri"],
    ...
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Leaf_litter","iri"],
    ["this:$(uniqid)#Leaf_litter", "sio:SIO_000300", "$(leaf_litter)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Plant_cover","iri"],
    ["this:$(uniqid)#Plant_cover", "sio:SIO_000300", "$(plant_cover)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Organic_matter","iri"],
    ["this:$(uniqid)#Organic_matter", "sio:SIO_000300", "$(organic_matter)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Topography","iri"],
    ["this:$(uniqid)#Topography", "sio:SIO_000300", "$(topography)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Geology","iri"],
    ["this:$(uniqid)#Geology", "sio:SIO_000300", "$(geology)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Habitat","iri"],
    ["this:$(uniqid)#Habitat", "sio:SIO_000300", "$(habitat)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Associated_plant_species","iri"],
    ["this:$(uniqid)#Associated_plant_species", "sio:SIO_000300", "$(associated_plant_species)", "xsd:string"],
    ["this:$(uniqid)#GeoLocation","sio:SIO_000008","this:$(uniqid)#Land_use","iri"],
    ["this:$(uniqid)#Land_use", "sio:SIO_000300", "$(land_use)", "xsd:string"],
