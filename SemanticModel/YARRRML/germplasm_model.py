...
data = {
  ...
  "triplets" : [
    ...
    ["this:$(uniqid)#Germplasm", "prov:wasUsedBy", "this:$(uniqid)#Plant_determination_process_lista_patron", "iri"],
    ["this:$(uniqid)#Germplasm", "sio:SIO_000231", "this:$(uniqid)#Plant_determination_process_WFO", "iri"],
    ["this:$(uniqid)#Germplasm", "sio:SIO_000231", "this:$(uniqid)#Plant_determination_process_lista_patron", "iri"],
    ["this:$(uniqid)#Plant_determination_process_WFO", "sio:SIO_000229", "this:$(uniqid)#Plant_identification_WFO", "iri"],
    ["this:$(uniqid)#Plant_determination_process_lista_patron", "sio:SIO_000229", "this:$(uniqid)#Plant_identification_lista_patron", "iri"],
    ...
    ["this:$(uniqid)#Plant_determination_process_lista_patron", "rdf:type", "prov:activity", "iri"],
    ["this:$(uniqid)#Plant_determination_process_lista_patron", "rdf:type", "sio:SIO_000006", "iri"],
    ...
    ["this:$(uniqid)#Plant_identification_WFO", "dwc:sientificName", "$(WFO_scientific_name)", "iri"],
    ["this:$(uniqid)#Plant_identification_WFO", "dwc:sientificNameAuthorship", "$(WFO_scientific_name_authorship)", "iri"],

    ["this:$(uniqid)#Plant_identification_lista_patron", "dwc:vernacularName", "$(lista_patron_vernacular_name)", "iri"],
    ["this:$(uniqid)#Plant_identification_lista_patron", "rdf:type", "dwc:Taxon", "iri"],
    ["this:$(uniqid)#Plant_identification_lista_patron", "dwc:sientificName", "$(lista_patron_scientific_name)", "iri"],
    ["this:$(uniqid)#Plant_identification_lista_patron", "dwc:sientificNameAuthorship", "$(lista_patron_scientific_name_authorship)", "iri"],

    ["this:$(uniqid)#Plant_identification_lista_patron", "sio:SIO_000671", "this:$(uniqid)#Lista_patron_identifier", "iri"],
    ["this:$(uniqid)#Plant_identification_WFO", "sio:SIO_000671", "this:$(uniqid)#WFO_identifier", "iri"],

    ["this:$(uniqid)#Lista_patron_identifier", "rdf:type", "sio:SIO_000115", "iri"],
    ["this:$(uniqid)#WFO_identifier", "rdf:type", "sio:SIO_000115", "iri"],
    ["this:$(uniqid)#Lista_patron_identifier", "sio:SIO_000300", "$(lista_patron_identifier)", "xsd:string"],
